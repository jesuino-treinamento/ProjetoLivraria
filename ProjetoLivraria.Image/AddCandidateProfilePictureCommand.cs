...
namespace ProjetoLivraria.Image
{
    public class AddCandidateProfilePictureCommand //: IAddCandidateProfilePictureCommand
    {
        ...
        //    var fileUrl =  WebConfigurationManager.AppSettings["CandidateProfilePictureAddress"];
